...
var drawControl, app, vectorLayer, tab, mapUI, layer_bat,layerArea, lastName, modifyControl, rect, vector, vectorPoint, activPts, sub;
	...
	Ext.onReady(function () {
		...
		var start_day = date_debut.substring(8,10);
		var finish_year = date_fin.substring(0,4);
		var finish_month = date_fin.substring(5,7);
		var finish_day = date_fin.substring(8,10);
		var limit = new OpenLayers.Layer.WMS("limite",
				    constants.adresseIP + "/geoserver/mada/wms/", {
				        layers: "mada:" + subdivision,
				        viewparams: "MIN_OBS_YEAR:"+ start_year +";MAX_OBS_YEAR:"+ finish_year +";MIN_OBS_MONTH:"+ start_month +
				        ";MAX_OBS_MONTH:"+ finish_month +";MIN_OBS_DAY:"+ start_day +";MAX_OBS_DAY:"+finish_day,
				        transparent: true,
				        format: "image/gif"
				    },
				    {
	  ...
	  //tree panel
	    ...
	    tab.push({
	        ...
	        columns: [],
	        bbar: [{
	        	 html: '<div class="logo-section"><img src="http://localhost:8080/Giz/img/giz_logo.png" class="img-logo" style="width: 144px;" alt="logo">' +
	            '<span class="text-logo">VANILLA PERIODIC MONITORING TOOLS</span></div>'
	        },
	        {
	            xtype: "button",
	            text: 'ACCUEIL',
	            ...
	            cls: 'pds-btn',
				handler: function () {
	                location.href = constants.dns + "/Giz/accueil"
	            }
	        ...
	        },
	        {
	            ...
	            cls: 'pds-btn',
	            handler: function () {
	                location.href = constants.dns + "/Giz/import"
	            }
...

	        {
	            ...
	            cls: 'pds-btn',
	            handler: function () {
	                location.href = constants.dns + "/Giz/beneficiaire"
	            }
...

	        {
	            ...
	            cls: 'pds-btn',
	            handler: function () {
	                location.href = constants.dns + "/Giz/indicateur"
	            }
	       ...
	       '->',
	        {
               ...
               '<div class="name-user"><tr><td><span>'+ users +'</span></td></tr></div>' +
