...
/* CANEVAS FERME DE REFERENCE */
	...
	public String saveElevage(@RequestParam("code_village") int code_village,
			...
			@RequestParam("genre_elev") int genre_elev , @RequestParam("annee_naiss") int annee_naiss, @RequestParam("operationnalite") int operationnalite,
	        ...
	        elevageService.addFerme(code_villag, cord_x, cord_y, nomResponsabl, genre, annee_nais, date_suiv, operationnels);
	...
	public String importFomPtAGC(@RequestParam("file") MultipartFile reapExcelDataFile, Model model ) throws IOException, ParseException {
	...
	public String savePt(@RequestParam("x") int x,
			...
			@RequestParam("superficies") int superficies, @RequestParam("date_suivi") int date_suivi, @RequestParam("technique_exergue") int technique_exergue,
	    ...
	    for(int i=1;i<worksheet.getPhysicalNumberOfRows() ;i++) {
	        ...
	        boolean operationnels = row.getCell(operationnalite).getStringCellValue().equalsIgnoreCase("Oui");
	        parcelleTestService.addParcelle_AGC(code_villag, coord_x, coord_y, nomResponsables, genre_pts, annee_nais, superficie, operationnels, date_suiv, technique_exergues);
...
/* CANEVAS PARTICIPANTS AUX PARCELLES DE DEMONSTRATION AGC */
	...
	public String importFomPtParticipant(@RequestParam("file") MultipartFile reapExcelDataFile, Model model ) throws IOException, ParseException {
	...
	public String saveParticipant(@RequestParam("x") int x,
			@RequestParam("code_village") int code_village, 
			@RequestParam("y") int y,
			@RequestParam("nomResponsable") int nomResponsable , @RequestParam("annee_naiss") int annee_naiss, @RequestParam("genre_pt") int genre_pt,
			 @RequestParam("date_suivi") int date_suivi, @RequestParam("nbr_homme") int nbr_homme,@RequestParam("nbr_femme") int nbr_femme,
			@RequestParam("nbr_participant") int nbr_participant , Model model ) throws IOException, ParseException {
		XSSFSheet worksheet = workbook.getSheetAt(0);	
	    for(int i=1;i<worksheet.getPhysicalNumberOfRows() ;i++) {
	        XSSFRow row = worksheet.getRow(i);
	        float coord_x = (float) row.getCell(x).getNumericCellValue();
	        ...
	        parcelleTestService.addParcelleParticipant(code_villag, coord_x, coord_y, nomResponsables, genre_pts, annee_nais,nbr_participants, nbr_hommes, nbr_femmes, date_suiv);
	...
	/* CANEVAS ELEVEURS FORMES ET ADOPTION DES BONNES PRATIQUES CONSEILLEES EN ELEVAGE */
	...
	public String importFomations(@RequestParam("file") MultipartFile reapExcelDataFile, Model model ) throws IOException, ParseException {
	...
	public String saveFomations(
			@RequestParam("code_village") int code_village, @RequestParam("nom_eleveur") int nom_eleveur, @RequestParam("annee_naiss") int annee_naiss,
			@RequestParam("genre_form") int genre_form, @RequestParam("genre_form") int adoption, @RequestParam("pratique_adopte") int pratique_adopte,
			@RequestParam("formation_recu") int formation_recu, @RequestParam("date_forma") int date_forma,
			@RequestParam("theme_formation") int theme_formation , Model model ) throws IOException, ParseException {
		XSSFSheet worksheet = workbook.getSheetAt(0);	
	    for(int i=1;i<worksheet.getPhysicalNumberOfRows() ;i++) {
	        XSSFRow row = worksheet.getRow(i);
	        String code_villag = row.getCell(code_village).getStringCellValue();
	        ...
	        formationsService.addFormEFA(code_villag, nom_eleveurs, genre, annee_nais, frm_rec, theme_formations, date_frms, adoptions, pratique_adoptes, type_formations);
...
/* CANEVAS FORMATEURS EN ELEVAGE OPERATIONNELS */
	...
	public String importFormateurElev(@RequestParam("file") MultipartFile reapExcelDataFile, Model model ) throws IOException, ParseException {
	...
	public String saveFormateurElev(@RequestParam("code_village") int code_village, 
			@RequestParam("genre_ft") int genre_ft,
	    ...
	    for(int i=1;i<worksheet.getPhysicalNumberOfRows() ;i++) {
	        ...
	        formateursService.addFormateurElevage(code_villag, nomPrenoms, genre_fts, date_naiss, operationnel, date_mise_places, date_suivis, type_forms);;
	...
	public String importFomFBS(@RequestParam("file") MultipartFile reapExcelDataFile, Model model ) throws IOException, ParseException {
	...
	public String saveFomFBS(
			@RequestParam("code_village") int code_village, @RequestParam("nom_eleveur") int nom_eleveur, @RequestParam("annee_naiss") int annee_naiss,
			@RequestParam("genre_form") int genre_form, 
			@RequestParam("formation_recu") int formation_recu, @RequestParam("date_forma") int date_forma,
			@RequestParam("theme_formation") int theme_formation , Model model ) throws IOException, ParseException {
		XSSFSheet worksheet = workbook.getSheetAt(0);	
	    for(int i=1;i<worksheet.getPhysicalNumberOfRows() ;i++) {
	        ...
	        formationsService.addFormations(code_villag, nom_eleveurs, genre, annee_nais, frm_rec, theme_formations, date_frms, type_formation);;
