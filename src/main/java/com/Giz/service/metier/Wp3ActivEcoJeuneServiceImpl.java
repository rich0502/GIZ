...
public class Wp3ActivEcoJeuneServiceImpl implements Wp3ActivEcoJeuneService {
	...
	// VILLAGE DETAIL TABLEAU COUNT
			...
			public List<Object[]> TableauCountDetailGenre(String village, String sexe) {
				// TODO Auto-generated method stub
				return wp3ActivEcoJeuneRepository.TableCountDetailGenre(village, sexe);
			}
			@Override
			public List<Object[]> TableauCountDetailGenreAll(String village) {
				// TODO Auto-generated method stub
				return wp3ActivEcoJeuneRepository.TableCountDetailGenreAll(village);
			}
			...
			public List<Object[]> TableauCountDetailGenreComm(String commune, String sexe) {
				// TODO Auto-generated method stub
				return wp3ActivEcoJeuneRepository.TableCountDetailGenreComm(commune, sexe);
			}
			@Override
			public List<Object[]> TableauCountDetailGenreAllComm(String commune) {
				// TODO Auto-generated method stub
				return wp3ActivEcoJeuneRepository.TableCountDetailGenreAllComm(commune);
			}
			...
			public List<Object[]> TableauCountDetailGenreDist(String district, String sexe) {
				// TODO Auto-generated method stub
				return wp3ActivEcoJeuneRepository.TableCountDetailGenreDist(district, sexe);
			}
			@Override
