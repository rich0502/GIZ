...
public interface BeneficiaireService {
	...
	public void addBeneficiaire(String nom_bf,
			String prenom_bf, String adresse_bf, String contact_bf, String date_naiss_bf);
	
	
	public void modifyBeneficiaire(Beneficiaire beneficiaire, String nom_bf,
			String prenom_bf, String adresse_bf, String contact_bf, String date_naiss_bf, Long id_bf);
