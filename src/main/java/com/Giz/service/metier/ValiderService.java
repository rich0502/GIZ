...
public interface ValiderService {
	...
	public void modifyL3(String code_village, String district, String nom_group_l_telo, String categorie,
			Date date_creation, double effectif_membre, int nbr_h, int nbr_f, boolean operationnel, Date date_suivi,
			Long id);
	...
	public void modifyVSLA(String code_village, String nom_vsla, int annee_creation, boolean vsla_lier_regionale,
			boolean appuis_recus, String type_appui, boolean operationnel, Date date_suivi, Long id);
	...
	public void modifyFBS(String code_village, boolean fbs_post_fbs_recus, boolean education_fbs_post_fbs,
	...
	public void modifyMoney(String code_village, String code_prod, String nom_prenom, String sexe, int annee_naissance,
			boolean service_mobile_money, Date date_suivi, boolean orange_money, boolean mvola, boolean airtel_money,
			Long id);
	...
	public void modifyFinance(String code_village, String code_prod, String nom_prenom, String sexe,
			int annee_naissance, boolean service_IMF, Date date_suivi, String institution, String lieu_agence, Long id);
	...
	public void modifyProducteur(String num_adhesion, String nom_beneficiaire, String nom_usuel_adherent,
			String contact, int age, Date date_naiss, String cin, String sexe, String code_village,
			String code_pro_symrise, String commune, String adresse_fkt, String affiliation, String ma_1ere_adhesion,
	...
	public void modifyAdhesion(String num_adhesion, String nom_beneficiaire, String nom_usuel_adherent, String contact,
			int age, Date date_naiss, String cin, String sexe, String code_village, String code_pro_symrise,
			String commune, String adresse_fkt, String affiliation, String ma_1ere_adhesion, int nbr_pers_charge,
			int annee_adhesion, Long id);
	...
	public void modifyMenage(String num_adhesion, String nom_beneficiaire, String nom_usuel_adherent, String contact,
			int age, Date date_naiss, String cin, String sexe, String code_village, String code_pro_symrise,
			String commune, String adresse_fkt, String affiliation, String ma_1ere_adhesion, int nbr_pers_charge,
			int annee_adhesion, Long id);
	...
	public List<Object[]> ListTableauCount(Date debut_date, Date fin_date, List<String> params, String sexe,
			String canevas);
	...
	public List<Object[]> ListTableauCountNoSexe(Date debut_date, Date fin_date, List<String> params, String canevas);
