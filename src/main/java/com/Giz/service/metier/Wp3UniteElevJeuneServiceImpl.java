...
public class Wp3UniteElevJeuneServiceImpl implements Wp3UniteElevJeuneService {
	...
	public List<Object[]> TableauCountDetailGenre(String village, String sexe) {
		// TODO Auto-generated method stub
		return wp3UniteElevJeuneRepository.TableCountDetailGenre(village, sexe);
	}
	@Override
	public List<Object[]> TableauCountDetailGenreAll(String village) {
		// TODO Auto-generated method stub
		return wp3UniteElevJeuneRepository.TableCountDetailGenreAll(village);
	}
	...
	public List<Object[]> TableauCountDetailGenreComm(String commune, String sexe) {
		// TODO Auto-generated method stub
		return wp3UniteElevJeuneRepository.TableCountDetailGenreComm(commune, sexe);
	}
	@Override
	public List<Object[]> TableauCountDetailGenreAllComm(String commune) {
		// TODO Auto-generated method stub
		return wp3UniteElevJeuneRepository.TableCountDetailGenreAllComm(commune);
	}
	...
	public List<Object[]> TableauCountDetailGenreDist(String district, String sexe) {
		// TODO Auto-generated method stub
		return wp3UniteElevJeuneRepository.TableCountDetailGenreDist(district, sexe);
	}
	@Override
