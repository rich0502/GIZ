...
public class Wp3AgrDevMfr {
	...
	public Wp3AgrDevMfr(Long id, String code_village, String nom_mfr, int annee_miseplace, String agr_developpe,
	...
	public String getAgr_developpe() {
		return agr_developpe;
	}

	public void setAgr_developpe(String agr_developpe) {
		this.agr_developpe = agr_developpe;
	}
