...
public class Adoption_innovation {
	 ...
	 * @param type
	 */
	public Adoption_innovation(Long id_ai, String code_pro, String nomPrenom_ai, String genre_ai, Date annee_naiss,
	 ...
	 */
	public void setAnnee_naiss(Date annee_naiss) {
		this.annee_naiss = annee_naiss;
	}
