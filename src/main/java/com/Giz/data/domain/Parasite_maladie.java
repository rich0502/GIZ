...
public class Parasite_maladie {
	...
	public Parasite_maladie() {
		super();
		// TODO Auto-generated constructor stub
	}

	public Parasite_maladie(Long id, String code_prod, String constate, String nom_mp, String periode,
			String pourcentage, String traitement, String type_traitement, String mecanique, String chimique,
			String chimique_qte, String biologique, String autre, String frequence, String effets) {
		super();
		this.id = id;
