...
public interface Wp3AgrDevMfrRepository extends JpaRepository<Wp3AgrDevMfr, Long> {
	...
	@Query(value = "SELECT village.code_village,village.village,count(wp3_agr_deev_mfr.sexe) as nbr, wp3_agr_deev_mfr.sexe FROM"
			...
			+ "GROUP BY village.code_village,village.village, wp3_agr_deev_mfr.sexe", nativeQuery = true)
	...
	@Query(value = "SELECT village.code_village,wp3_agr_deev_mfr.nom_mfr FROM village,wp3_agr_deev_mfr WHERE"
			+ " village.code_village=wp3_agr_deev_mfr.code_village AND village.village = ?1   AND wp3_agr_deev_mfr.sexe= ?2 \r\n", nativeQuery = true)
	List<Object[]> TableCountDetailGenre(String village, String sexe);

	@Query(value = "SELECT village.code_village,wp3_agr_deev_mfr.nom_mfr FROM village,wp3_agr_deev_mfr WHERE"
			+ " village.code_village=wp3_agr_deev_mfr.code_village AND village.village = ?1   \r\n", nativeQuery = true)
	List<Object[]> TableCountDetailGenreAll(String village);

	// COMMUNE DETAIL TABLEAU COUNT

	@Query(value = "SELECT village.code_village,wp3_agr_deev_mfr.nom_mfr FROM village,wp3_agr_deev_mfr WHERE"
			+ " village.code_village=wp3_agr_deev_mfr.code_village AND village.commune = ?1   AND upper(wp3_agr_deev_mfr.sexe= ?2) \r\n", nativeQuery = true)
	List<Object[]> TableCountDetailGenreComm(String commune, String sexe);

	@Query(value = "SELECT village.code_village,wp3_agr_deev_mfr.nom_mfr FROM village,wp3_agr_deev_mfr WHERE"
			+ " village.code_village=wp3_agr_deev_mfr.code_village AND village.commune = ?1   \r\n", nativeQuery = true)
	List<Object[]> TableCountDetailGenreAllComm(String commune);

	// DISTRICT DETAIL TABLEAU COUNT

	@Query(value = "SELECT village.code_village,wp3_agr_deev_mfr.nom_mfr FROM village,wp3_agr_deev_mfr WHERE"
			+ " village.code_village=wp3_agr_deev_mfr.code_village AND village.district = ?1   AND wp3_agr_deev_mfr.sexe= ?2 \r\n", nativeQuery = true)
