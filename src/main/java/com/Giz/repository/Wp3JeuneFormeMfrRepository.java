...
public interface Wp3JeuneFormeMfrRepository extends JpaRepository<Wp3JeuneFormeMfr, Long> {

	@Query("select count(*) from Wp3JeuneFormeMfr where accompagne_sortie='true' ")
	long countAll();

	@Query("select count(*) from Wp3JeuneFormeMfr where accompagne_sortie='true' and lower(sexe)=:sexe")
	long countGenre(String sexe);

	@Query(value = "select count(*) from wp3_jeune_forme_mfr where accompagne_sortie='true' and date_suivi BETWEEN cast(TO_DATE('01/01/2020', 'DD/MM/YYYY') as date) and cast(TO_DATE(:dateChronologique, 'DD/MM/YYYY') as date)", nativeQuery = true)
	...
	@Query(value = "SELECT count(*) as y FROM wp3_jeune_forme_mfr WHERE date_suivi BETWEEN :debut_date AND :fin_date", nativeQuery = true)
	long SomTotal(java.util.Date debut_date, java.util.Date fin_date);

	@Query(value = "SELECT village.district,count(village.district) as y from village,wp3_jeune_forme_mfr where village.code_village=wp3_jeune_forme_mfr.code_village group by village.district", nativeQuery = true)
	List<Object[]> fetchData();

	// count
	@Query(value = "SELECT count(village.district) as y from village,wp3_jeune_forme_mfr WHERE village.code_village=wp3_jeune_forme_mfr.code_village", nativeQuery = true)
	long CamembertTot();
	...
	@Query(value = "SELECT village.code_village,village.village,count(wp3_jeune_forme_mfr.sexe) as nbr, wp3_jeune_forme_mfr.sexe FROM"
			...
			+ "GROUP BY village.code_village,village.village, wp3_jeune_forme_mfr.sexe", nativeQuery = true)
	List<Object[]> TableData(Date debut_date, Date fin_date, List<String> params, String sexe);

	@Query(value = "SELECT village.commune,count(wp3_jeune_forme_mfr.sexe) as nbr, wp3_jeune_forme_mfr.sexe FROM"
			...
			+ "GROUP BY village.commune, wp3_jeune_forme_mfr.sexe", nativeQuery = true)
	...
	@Query(value = "select hommes.code_village,hommes.village,hommes.homme,femmes.femme\r\n"
			+ "	from (SELECT village.code_village,village.village,count(wp3_jeune_forme_mfr.sexe) as homme FROM"
			+ "	 village,wp3_jeune_forme_mfr WHERE wp3_jeune_forme_mfr.sexe= 'H' AND village.code_village=wp3_jeune_forme_mfr.code_village AND wp3_jeune_forme_mfr.code_village \r\n"
			+ " IN (null, ?3) AND wp3_jeune_forme_mfr.date_suivi BETWEEN ?1 AND ?2 \r\n"
			+ "GROUP BY village.code_village,village.village) as hommes,\r\n"
			+ "	(SELECT village.code_village,village.village,count(wp3_jeune_forme_mfr.sexe) as femme FROM\r\n"
			+ "	 village,wp3_jeune_forme_mfr WHERE wp3_jeune_forme_mfr.sexe= 'F' AND village.code_village=wp3_jeune_forme_mfr.code_village AND wp3_jeune_forme_mfr.code_village \r\n"
			+ " IN (null, ?3) AND wp3_jeune_forme_mfr.date_suivi BETWEEN ?1 AND ?2 \r\n"
	...
	@Query(value = "select hommes.commune,hommes.homme,femmes.femme\r\n"
			+ "	from (SELECT village.commune,count(wp3_jeune_forme_mfr.sexe) as homme FROM\r\n"
			+ "	 village,wp3_jeune_forme_mfr WHERE village.code_village=wp3_jeune_forme_mfr.code_village AND\r\n"
			+ "	wp3_jeune_forme_mfr.date_suivi BETWEEN ?1 AND ?2 \r\n" + "	and wp3_jeune_forme_mfr.sexe = 'H'\r\n"
			+ "	GROUP BY village.commune) as hommes,\r\n"
			+ "	(SELECT village.commune,count(wp3_jeune_forme_mfr.sexe) as femme FROM\r\n"
			+ "	 village,wp3_jeune_forme_mfr WHERE village.code_village=wp3_jeune_forme_mfr.code_village AND\r\n"
			+ "	wp3_jeune_forme_mfr.date_suivi BETWEEN ?1 AND ?2 \r\n" + " and wp3_jeune_forme_mfr.sexe = 'F'\r\n"
	...
	@Query(value = "select hommes.district,hommes.homme,femmes.femme\r\n"
			+ "	from (SELECT village.district,count(wp3_jeune_forme_mfr.sexe) as homme FROM\r\n"
			+ "	 village,wp3_jeune_forme_mfr WHERE village.code_village=wp3_jeune_forme_mfr.code_village AND\r\n"
			+ "	wp3_jeune_forme_mfr.date_suivi BETWEEN ?1 AND ?2 \r\n" + "	and wp3_jeune_forme_mfr.sexe = 'H'\r\n"
			+ "	GROUP BY village.district) as hommes,\r\n"
			+ "	(SELECT village.district,count(wp3_jeune_forme_mfr.sexe) as femme FROM\r\n"
			+ "	 village,wp3_jeune_forme_mfr WHERE village.code_village=wp3_jeune_forme_mfr.code_village AND\r\n"
			+ "	wp3_jeune_forme_mfr.date_suivi BETWEEN ?1 AND ?2 \r\n" + " and wp3_jeune_forme_mfr.sexe = 'F'\r\n"
	...
	@Query(value = "SELECT village.code_village,wp3_jeune_forme_mfr.nom_prenom FROM village,wp3_jeune_forme_mfr WHERE"
			+ " village.code_village=wp3_jeune_forme_mfr.code_village AND village.village = ?1   AND upper(wp3_jeune_forme_mfr.sexe)= ?2 \r\n", nativeQuery = true)
	List<Object[]> TableCountDetailGenre(String village, String sexe);

	@Query(value = "SELECT village.code_village,wp3_jeune_forme_mfr.nom_prenom FROM village,wp3_jeune_forme_mfr WHERE"
			+ " village.code_village=wp3_jeune_forme_mfr.code_village AND village.village = ?1   \r\n", nativeQuery = true)
	List<Object[]> TableCountDetailGenreAll(String village);

	// COMMUNE DETAIL TABLEAU COUNT

	@Query(value = "SELECT village.code_village,wp3_jeune_forme_mfr.nom_prenom FROM village,wp3_jeune_forme_mfr WHERE"
			+ " village.code_village=wp3_jeune_forme_mfr.code_village AND village.commune = ?1   AND upper(wp3_jeune_forme_mfr.sexe)= ?2 \r\n", nativeQuery = true)
	List<Object[]> TableCountDetailGenreComm(String commune, String sexe);

	@Query(value = "SELECT village.code_village,wp3_jeune_forme_mfr.nom_prenom FROM village,wp3_jeune_forme_mfr WHERE"
			+ " village.code_village=wp3_jeune_forme_mfr.code_village AND village.commune = ?1   \r\n", nativeQuery = true)
	List<Object[]> TableCountDetailGenreAllComm(String commune);

	// DISTRICT DETAIL TABLEAU COUNT

	@Query(value = "SELECT village.code_village,wp3_jeune_forme_mfr.nom_prenom FROM village,wp3_jeune_forme_mfr WHERE"
			+ " village.code_village=wp3_jeune_forme_mfr.code_village AND village.district = ?1   AND upper(wp3_jeune_forme_mfr.sexe)= ?2 \r\n", nativeQuery = true)
