...
public interface Wp3FedeMfrRepository extends JpaRepository<Wp3FedeMfr, Long> {
	...
	@Query(value = "SELECT village.code_village,village.commune,count(wp3_fede_mfr.sexe) as nbr, wp3_fede_mfr.sexe FROM"
			...
			"GROUP BY village.code_village,village.commune, wp3_fede_mfr.sexe", nativeQuery = true)
