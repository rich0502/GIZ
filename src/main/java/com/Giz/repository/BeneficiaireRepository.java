...
public interface BeneficiaireRepository extends JpaRepository<Valider, Long> {
	...
	// WP3 Beneficiaire
	@Query(value="select DISTINCT nom_prenom, sexe, annee_naissance from (select nom_prenom,sexe,annee_naissance from wp3_activ_eco_jeune union all select nom_prenom,sexe,annee_naissance from wp3_unite_elev_jeune union all select nom_prenom,sexe,annee_naissance from wp3_elev_mfr union all select nom_prenom,sexe,annee_naissance from wp3_jeune_forme_mfr union all select nom_prenom,sexe,annee_naissance from wp3_eequipe_tech_mfr union all select nom_prenom,sexe,annee_naissance from wp3_jeune_pathway union all select nom_prenom,sexe,annee_naissance from wp3_peer_educator ) sub", nativeQuery = true)
